...
public class TekoraFluids {
    ...
    public static final RegistryObject<FlowingFluid> SOURCE_CHLORINE = FLUIDS.register("chlorine",
            () -> new ForgeFlowingFluid.Source(TekoraFluids.CHLORINE_FLOWING_PROPERTIES));
    public static final RegistryObject<FlowingFluid> FLOWING_CHLORINE = FLUIDS.register("flowing_chlorine",
            () -> new ForgeFlowingFluid.Flowing(TekoraFluids.CHLORINE_FLOWING_PROPERTIES));


    public static final ForgeFlowingFluid.Properties CHLORINE_FLOWING_PROPERTIES = new ForgeFlowingFluid.Properties(
            TekoraFluidTypes.CHLORINE_FLUID_TYPE, SOURCE_CHLORINE, FLOWING_CHLORINE)
            .slopeFindDistance(2).levelDecreasePerBlock(2).block(TekoraBlocks.CHLORINE_BLOCK);
