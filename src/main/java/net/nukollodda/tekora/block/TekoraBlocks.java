...
import net.nukollodda.tekora.block.fluid.blocks.TekoraLiquidMixtureBlock;
...
public class TekoraBlocks {
    ...
    public static final RegistryObject<Block> TUFF_PENTLANDITE_ORE = registerBlock("tuff_pentlandite_ore",
            () -> new TekoraExperienceBlock(4.8f,2.5f, SoundType.TUFF, UniformInt.of(1, 3)));
    public static final RegistryObject<Block> RUBY_ORE = registerBlock("ruby_ore",
            () -> new TekoraExperienceBlock(9f,4.5f, UniformInt.of(1, 4)));
    public static final RegistryObject<Block> DEEPSLATE_RUBY_ORE = registerBlock("deepslate_ruby_ore",
            () -> new TekoraExperienceBlock(15f,5.6f, SoundType.DEEPSLATE, UniformInt.of(1, 4)));
    public static final RegistryObject<Block> SAPPHIRE_ORE = registerBlock("sapphire_ore",
            () -> new TekoraExperienceBlock(9f,4.5f, UniformInt.of(1, 4)));
    public static final RegistryObject<Block> DEEPSLATE_SAPPHIRE_ORE = registerBlock("deepslate_sapphire_ore",
            () -> new TekoraExperienceBlock(15f,5.6f, SoundType.DEEPSLATE, UniformInt.of(1, 4)));
    public static final RegistryObject<Block> SILVER_ORE = registerBlock("silver_ore",
            () -> new TekoraExperienceBlock(2f,1.4f, UniformInt.of(1, 3)));
    public static final RegistryObject<Block> DEEPSLATE_SILVER_ORE = registerBlock("deepslate_silver_ore",
            () -> new TekoraExperienceBlock(3.5f,1.5f, SoundType.DEEPSLATE, UniformInt.of(1, 3)));
    ...
    public static final RegistryObject<Block> GRANITE_ZIRCON_ORE = registerBlock("granite_zircon_ore",
            () -> new TekoraExperienceBlock(6.75f,4.5f));
    public static final RegistryObject<Block> SANDSTONE_ZIRCON_ORE = registerBlock("sandstone_zircon_ore",
            () -> new TekoraExperienceBlock(4f,2.5f));
