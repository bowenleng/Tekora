...
public class TekoraFluidPresets {
    ...
    public static final TekoraFluidData TRITIUM = new TekoraFluidData(new TekoraFluidData.Properties()
            .setMeltingPoint(21)
    ...
    public static final TekoraFluidData HELIUM = new TekoraFluidData(new TekoraFluidData.Properties()
    ...
    public static final TekoraFluidData NEON = new TekoraFluidData(new TekoraFluidData.Properties()
            .setMeltingPoint(21)
    ...
    public static final TekoraFluidData ARGON = new TekoraFluidData(new TekoraFluidData.Properties()
    ...
    // liquid density = 3120
    // gas density = 8
    public static final TekoraFluidData KRYPTON = new TekoraFluidData(new TekoraFluidData.Properties()
            .setMeltingPoint(115)
    ...
    // liquid density = 1320
    // gas density = 11
    public static final TekoraFluidData XENON = new TekoraFluidData(new TekoraFluidData.Properties()
            .setMeltingPoint(160)
