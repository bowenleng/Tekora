...
public enum ModArmors implements ArmorMaterial {
    ...
    private ModArmors(String name, int durabilityFactor, int[] slotProtect, int enchantVal, SoundEvent sound, float tough, float knockRes, Supplier<Ingredient> repair) {
        this.name = name;
