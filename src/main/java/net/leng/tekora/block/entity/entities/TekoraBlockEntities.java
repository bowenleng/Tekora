...
import net.leng.tekora.block.entity.entities.connectors.EnergyCableEntity;
import net.leng.tekora.block.entity.entities.connectors.EnergyCableFacadeEntity;
import net.leng.tekora.block.entity.entities.storage.InfiniteBatteryEntity;
import net.leng.tekora.block.entity.entities.generators.HydroelectricGeneratorEntity;
