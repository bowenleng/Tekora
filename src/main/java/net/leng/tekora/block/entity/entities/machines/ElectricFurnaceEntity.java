...
import net.leng.tekora.block.entity.blocks.machines.ElectricFurnace;
...
import net.leng.tekora.menu.ElectricFurnaceMenu;
import net.leng.tekora.recipes.types.ElectricBlastingRecipe;
