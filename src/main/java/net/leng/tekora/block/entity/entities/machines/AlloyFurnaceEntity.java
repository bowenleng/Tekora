...
import net.leng.tekora.block.entity.blocks.machines.AlloyFurnace;
...
import net.leng.tekora.block.entity.entities.machines.types.AbstractTekoraFurnaceEntity;
import net.leng.tekora.menu.AlloyFurnaceMenu;
import net.leng.tekora.recipes.types.AlloyingRecipe;
import net.leng.tekora.util.UtilFunctions;
