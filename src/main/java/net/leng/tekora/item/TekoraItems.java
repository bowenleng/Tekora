...
import net.leng.tekora.item.armors.TekoraArmor;
import net.leng.tekora.item.containers.Canister;
import net.leng.tekora.item.containers.TekoraBucketItem;
import net.leng.tekora.item.isotopic.Lithium;
...
import net.leng.tekora.item.armors.HeatResArmor;
import net.leng.tekora.tiers.TekoraArmors;
