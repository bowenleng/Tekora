package net.leng.tekora.client.screens;
...
import net.leng.tekora.menu.InfusionFurnaceMenu;

public class InfusionFurnaceScreen extends AbstractContainerScreen<InfusionFurnaceMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Tekora.MODID, "textures/screens/infusion_furnace_gui.png");

    public InfusionFurnaceScreen(InfusionFurnaceMenu menu, Inventory inventory, Component title) {
