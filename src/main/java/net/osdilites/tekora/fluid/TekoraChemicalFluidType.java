...
import net.osdilites.tekora.fluid.data.TekoraFluidData;
import org.jetbrains.annotations.NotNull;
import org.joml.Vector3f;

import java.util.function.Consumer;

public class TekoraChemicalFluidType extends FluidType {
    ...
    public TekoraChemicalFluidType(final Properties properties, final TekoraFluidData data, final boolean isGas) {
        super(properties);
    ...
    public float getRadioactivity() {
        return fluidData.getRadioactivity();
    }
    ...
    public int getReactivity() {
        return (fluidData.doesDecompose() ? 1 : 0) + Math.round(Math.abs((fluidData.getHydrogenationRate() - 7) / 10));
    }
