...
public record ReactionRecipeInput(List<Chemical> reactants, List<Chemical> products, Catalyst catalyst, double temperature, double availableEnergy) implements RecipeInput {
    @Override
