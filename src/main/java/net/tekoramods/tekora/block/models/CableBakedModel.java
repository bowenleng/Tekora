...
import net.tekoramods.tekora.block.entity.blocks.connecters.AbstractConnector;
...
import static net.tekoramods.tekora.block.models.CablePatterns.SpriteIdx.*;
...
public class CableBakedModel implements IDynamicBakedModel {
    ...
    public @NotNull List<BakedQuad> getQuads(@Nullable BlockState state, @Nullable Direction side, @NotNull RandomSource rand, @NotNull ModelData extraData, @Nullable RenderType layer) {
        ...
        if (side == null && (layer == null || layer.equals(RenderType.solid()))) {
            ...
            if (up == AbstractConnector.ConnectorType.CABLE) {
            ...
            if (down == AbstractConnector.ConnectorType.CABLE) {
            ...
            if (east == AbstractConnector.ConnectorType.CABLE) {
            ...
            if (west == AbstractConnector.ConnectorType.CABLE) {
            ...
            if (north == AbstractConnector.ConnectorType.CABLE) {
            ...
            if (south == AbstractConnector.ConnectorType.CABLE) {
