...
import net.tekoramods.tekora.item.typical.IonicParts;
import net.tekoramods.tekora.item.typical.ICompounds;
import net.tekoramods.tekora.item.typical.RawItem;
import net.tekoramods.tekora.util.DustUtil;
...
public class Protactinium extends AbstractRadioactiveItem {
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        ...
        pTooltipComponents.add(radComponent(getRadiation(pStack)));
